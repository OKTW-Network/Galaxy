...
val fabricVersion = "0.58.5+1.19.1"
val galaxyLibVersion = "64db4f57"
...
dependencies {
    // Core
    minecraft(group = "com.mojang", name = "minecraft", version = "1.19.1")
    mappings(group = "net.fabricmc", name = "yarn", version = "1.19.1+build.1", classifier = "v2")
