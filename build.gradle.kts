...
dependencies {
    ...
    mappings(group = "net.fabricmc", name = "yarn", version = "1.17.1+build.10", classifier = "v2")
    modImplementation(group = "net.fabricmc", name = "fabric-loader", version = "0.11.6")

    // fabric api
    modImplementation(group = "net.fabricmc.fabric-api", name = "fabric-api", version = "0.36.1+1.17")
