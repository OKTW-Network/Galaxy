...
object DispenserPlant {
    ...
    fun register() {
        ...
        DispenserBlock.registerBehavior(Items.OAK_SAPLING, seedsDispenserBehavior(Blocks.OAK_SAPLING, listOf(Blocks.GRASS_BLOCK, Blocks.DIRT, Blocks.PODZOL, Blocks.FARMLAND)))
        DispenserBlock.registerBehavior(Items.BIRCH_SAPLING, seedsDispenserBehavior(Blocks.BIRCH_SAPLING, listOf(Blocks.GRASS_BLOCK, Blocks.DIRT, Blocks.PODZOL, Blocks.FARMLAND)))
        DispenserBlock.registerBehavior(Items.SPRUCE_SAPLING, seedsDispenserBehavior(Blocks.SPRUCE_SAPLING, listOf(Blocks.GRASS_BLOCK, Blocks.DIRT, Blocks.PODZOL, Blocks.FARMLAND)))
        DispenserBlock.registerBehavior(Items.JUNGLE_SAPLING, seedsDispenserBehavior(Blocks.JUNGLE_SAPLING, listOf(Blocks.GRASS_BLOCK, Blocks.DIRT, Blocks.PODZOL, Blocks.FARMLAND)))
        DispenserBlock.registerBehavior(Items.ACACIA_SAPLING, seedsDispenserBehavior(Blocks.ACACIA_SAPLING, listOf(Blocks.GRASS_BLOCK, Blocks.DIRT, Blocks.PODZOL, Blocks.FARMLAND)))
        DispenserBlock.registerBehavior(Items.DARK_OAK_SAPLING, seedsDispenserBehavior(Blocks.DARK_OAK_SAPLING, listOf(Blocks.GRASS_BLOCK, Blocks.DIRT, Blocks.PODZOL, Blocks.FARMLAND)))
